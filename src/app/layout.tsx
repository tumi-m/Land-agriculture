...
export const metadata: Metadata = {
  ...
  description:
    'Find state agricultural land released for farming in South Africa — by province, district, size and enterprise, with the size, application process and contact office for every parcel.',
